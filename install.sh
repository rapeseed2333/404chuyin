...
update_file ./resources/weights.zip $DATA_DOWNLOAD_URL/weights.zip 68015604d4333a9c3122dd80d6da4047
if [ $? -ne 0 ]
then
...
update_file ./resources/linux-work.zip $DATA_DOWNLOAD_URL/linux-work.zip 1158e8a7ffb2817827201b5be8ac15ca
if [ $? -ne 0 ]
then
...
then
    ...
    #install tensorrt
    if [ "$TENSORRT_REPO" == "ALI" ]
    then
        echo "deb https://mirrors.aliyun.com/nvidia-cuda/ubuntu${OS_VERSION}/x86_64 /" > /etc/apt/sources.list.d/cuda.list
